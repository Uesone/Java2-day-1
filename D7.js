...
const nome = "aldo";
const cognome = "baglio";

function concatenazione(nome, cognome) {
  const primiDueCaratteri = nome.substring(0, 2);
  const ultimiTreCaratteri = cognome.substring(cognome.length - 3);
  console.log((primiDueCaratteri + ultimiTreCaratteri).toUpperCase());
}
